...
final healthTips = <HealthTip>[
  ...
  HealthTip(
    id: 'symptom-diary-is-useful',
    category: TipCategory.understanding,
    title: 'A small log can tell a much bigger story',
  ...
  HealthTip(
    id: 'pms-timing-matters',
    category: TipCategory.symptoms,
    title: 'For PMS, timing is part of the clue',
    flash: 'Premenstrual symptoms tend to appear before a period and ease after bleeding begins.',
    details: [
      'NHS guidance describes PMS symptoms as typically starting or intensifying in the two weeks before a period and then easing after the period starts.',
      'A recurring relationship with your cycle is more informative than assuming any isolated mood, headache or bloating episode is PMS.',
    ],
    seekCare: [
      'If recurring symptoms are affecting everyday life, ask a healthcare professional for help rather than simply accepting them as something you have to tolerate.',
    ],
    tags: ['PMS', 'timing', 'mood', 'symptoms'],
    sources: [nhsPeriodProblems, nhsPms],
    version: 1,
    lastReviewed: _reviewed,
  ),
  HealthTip(
    id: 'menstrual-migraine-pattern',
    category: TipCategory.symptoms,
    title: 'Some migraines have a menstrual pattern',
    flash: 'Migraine attacks can cluster around the start of a period, so the timing is worth logging.',
    details: [
      'NHS guidance describes menstrual migraine as commonly occurring around the two days before a period starts or during the first three days of bleeding.',
      'A headache diary can help reveal whether attacks repeatedly follow that pattern. Regular meals, hydration, sleep, movement and stress management are also part of general migraine self-care guidance.',
    ],
    seekCare: [
      'Speak with a healthcare professional if you get menstrual migraines, if attacks are difficult to control, or if your headache pattern changes significantly.',
    ],
    tags: ['migraine', 'headache', 'timing', 'tracking'],
    sources: [nhsPeriodProblems, nhsMigraine],
    version: 1,
    lastReviewed: _reviewed,
  ),
  HealthTip(
  ...
  HealthTip(
    id: 'heavy-flow-and-iron',
    category: TipCategory.seekCare,
    title: 'Heavy flow can quietly drain iron',
    flash: 'Ongoing heavy periods can contribute to iron-deficiency anaemia.',
    details: [
      'Iron is needed to make haemoglobin, which helps red blood cells carry oxygen. Repeated heavy blood loss can lower the body’s iron stores over time.',
      'Possible symptoms include unusual fatigue or weakness, dizziness, headaches, pale skin and shortness of breath. These symptoms are not specific to anaemia, so testing matters.',
    ],
    seekCare: [
      'If heavy periods are paired with persistent fatigue, weakness, dizziness or breathlessness, ask a healthcare professional whether assessment for anaemia is appropriate.',
      'Do not start iron tablets simply because your period is heavy. Official guidance recommends discussing iron supplements with a healthcare professional first.',
    ],
    tags: ['heavy flow', 'iron', 'anaemia', 'fatigue', 'dizziness'],
    sources: [owhIronDeficiency, acogHeavy],
    version: 1,
    lastReviewed: _reviewed,
  ),
  HealthTip(
